...
class LokasiEditScreen extends StatefulWidget {
  final DataLokasi lokasi;

  const LokasiEditScreen({super.key, required this.lokasi});

  @override
  State<LokasiEditScreen> createState() => _LokasiEditScreenState();
}

class _LokasiEditScreenState extends State<LokasiEditScreen> {
  ...
  void initState() {
    super.initState();
    initialProjectName = widget.lokasi.namaProject;
    namaController = TextEditingController(text: widget.lokasi.namaLokasi);
    _projectController = TextEditingController(text: widget.lokasi.namaProject);
                                          ...
                                          if (_formKey.currentState!
                                            ...
                                            final requestModel =
                                                LokasiRequestModel(
                                                  namaLokasi:
                                                      namaController.text,
                                                  idProject: selectedProject?.idProject ?? widget.lokasi.idProject,
                                                );
