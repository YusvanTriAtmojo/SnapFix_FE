              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                                ...
                                return Expanded(
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: isSelected ?  Color(0xFF002F87) : Colors.transparent,
                   ...
                   Expanded(
                      child: BlocConsumer<KerusakanBloc, KerusakanState>(
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(color: Color(0xFF002F87)),
                                        ),
                                        child: Text(
                                  ...
                                  child: filteredList.isEmpty
                                      ? const Center(
                                          child: Text(
                                            ...
                                            style: TextStyle(color: Color(0xFF002F87)),
                                          ),
                                        )
                                      : ListView.separated(
                                    ...
                                    children: [
                                      ElevatedButton(
                                        ...
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Colors.white, 
                                          foregroundColor: Color(0xFF003C97), 
                                          shape: RoundedRectangleBorder(
