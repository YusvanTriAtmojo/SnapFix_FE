...
import 'package:damagereports/presentation/admin/lokasi/lokasi_add_screen.dart';
import 'package:damagereports/presentation/admin/lokasi/lokasi_edit_screen.dart';
...
class _LokasiScreenState extends State<LokasiScreen> {
  ...
  void initState() {
    super.initState();
    context.read<LokasiBloc>().add(LokasiRequested());
    ...
    _searchController.addListener(() {
      ...
      if (!RegExp(r'^[a-zA-Z\s]*$').hasMatch(query)) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text(
              "Lokasi hanya bisa dicari dengan huruf.",
              style: TextStyle(
                color: Colors.black,
      ...
      context.read<LokasiBloc>().add(LokasiFiltered(query));
    });
  }
                            ...
                            Expanded(
                              child: BlocConsumer<LokasiBloc, LokasiState>(
                                listener: (context, state) {
                                  if (state is LokasiDeleteFailure) {
                                  ...
                                  } else if (state is LokasiOperationSuccess) {
