...
class _UserEditScreenState extends State<UserEditScreen> {
  ...
  void initState() {
    ...
    nipController = TextEditingController(text: widget.user.nip);
    emailController = TextEditingController(text: widget.user.email);
    notlpController = TextEditingController(text: widget.user.notlp);
    alamatController = TextEditingController(text: widget.user.alamat);
    _projectController = TextEditingController(text: widget.user.namaProject);
    _roleController = TextEditingController(text: widget.user.namaRole);
                                          ...
                                          if (_formKey.currentState!
                                            ...
                                            final requestModel =
                                                UserAdminRequestModel(
                                                  ...
                                                  idProject: selectedProject?.idProject ?? widget.user.idProject,
                                                  idRole: selectedRole?.idRole ?? widget.user.idRole,
                                                );
